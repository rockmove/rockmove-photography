  ...
  return (
    <div className='w-full'>
      <dl className='grid grid-cols-[2fr_1fr]'>
        ...
        <dd className='flex justify-center items-center p-10'>
          <div>
            <h2 className={`${dmSerifText.className} text-5xl mb-7`}>
              Prolile{" "}
              <span className={`${notoSerifJP.className} ml-3 text-xl`}>
                （自己紹介）
              </span>
            </h2>
            <p className={`${notoSerifJP.className} mb-7 text-xl`}>
            ...
            <dl className='flex items-center mb-4'>
              ...
              <dd className={`${dmSerifText.className} ml-4 text-xl`}>
